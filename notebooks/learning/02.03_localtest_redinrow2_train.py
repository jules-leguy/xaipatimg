...
train_dataset_filename = "red_in_row_2_train.csv"
test_dataset_filename = "red_in_row_2_test.csv"
valid_dataset_filename = "red_in_row_2_valid.csv"
...
train_resnet18_model(db_dir, train_dataset_filename, valid_dataset_filename, model_dir, device=device, training_epochs=40)
