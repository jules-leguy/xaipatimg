...
train_dataset_filename = "exactly_6_squares_train.csv"
test_dataset_filename = "exactly_6_squares_test.csv"
valid_dataset_filename = "exactly_6_squares_valid.csv"
model_dir = os.environ["DATA"] + "models/db0.1.4_6x6/exactly_6_squares_80accuracy_model/"
