...
train_dataset_filename = "foursquares_train.csv"
test_dataset_filename = "foursquares_test.csv"
valid_dataset_filename = "foursquares_valid.csv"
model_dir = os.environ["DATA"] + "models/db_v0.1.3/foursquares_model/"
