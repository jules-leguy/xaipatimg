...
train_dataset_filename = "twice_as_many_green_as_red_train.csv"
test_dataset_filename = "twice_as_many_green_as_red_test.csv"
valid_dataset_filename = "twice_as_many_green_as_red_valid.csv"
model_dir = os.environ["DATA"] + "models/db0.1.4_6x6/twice_as_many_green_as_red_80accuracy_model/"
classification_dir = os.environ["DATA"] + "classification/db0.1.4_6x6/"
