...
train_dataset_filename = "exactly_6_red_symbols_train.csv"
test_dataset_filename = "exactly_6_red_symbols_test.csv"
valid_dataset_filename = "exactly_6_red_symbols_valid.csv"
model_dir = os.environ["DATA"] + "models/db0.1.4_6x6/exactly_6_red_symbols_80accuracy_model/"
