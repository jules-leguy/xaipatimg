...
train_dataset_filename = "threesquares_train.csv"
test_dataset_filename = "threesquares_test.csv"
valid_dataset_filename = "threesquares_valid.csv"
model_dir = os.environ["DATA"] + "models/db_v0.1.3/threesquares_model/"
